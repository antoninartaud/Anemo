...
export default function Signup(props) {
    ...
    try {
      ...
      if (validationErrors.length === 0) {
        ...
        if (result) {
          ...
          alert('There was a problem in result postSignup');
        }
      } else {
  ...
  // Affichage Message 'User Created' si pas d'erreur dans SignUP Form - FG comment

  // console.log('userCreated', userCreated);

  return (
    // Si erreur dans SignUP Message d'erreur avec liste des erreurs et SignUP Form again en dessous - FG comment
    <div
